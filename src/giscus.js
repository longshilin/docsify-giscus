...
function renderGiscus(config){
    ...
    giscus.dataset["repo"] = config.repo;//"longshilin/w";
    giscus.dataset["repoId"] = config.repoId;//"R_kgDOKAwvLA";
    giscus.dataset["categoryId"] = config.categoryId;//"DIC_kwDOKAwvLM4CYMO";
